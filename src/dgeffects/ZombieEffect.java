...
public class ZombieEffect extends AppliedEffect {
	...
	public ZombieEffect(CreatureCard source) {
		super(new CreatureMoveToField(source), new UnionCondition(new OtherCreaturesDiedCondition(source), new InGraveyardCondition(source)), source, true, Priority.YIELD, "Zombie");
	}
}
